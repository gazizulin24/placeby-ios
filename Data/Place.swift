...
struct Place: Equatable {
    ...
    static let basicPlaces: [Place] = {
        ...
        places.append(Place(name: "Минский Радиотехнический Колледж", description: "Лучший колледж страны", distantion: "3,5км", images: ["mrk", "mrk2"], coordinates: PlaceCoordinates(latitude: 53.919234, longitude: 27.592757)))
