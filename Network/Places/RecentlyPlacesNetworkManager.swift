...
class RecentlyPlacesNetworkManager {
    ...
    static func makeGetRecentlyPlacesForPersonWithIdRequest(id:Int, completion: @escaping (GetRecentlyPlacesResponseEntity?) -> ()){
    ...
    static func makeDeleteRecentlyPlacesForPersonWithIdRequest(id:Int, completion: @escaping (DeleteAllRecentlyPlacesResponseEntity?) -> ()){
