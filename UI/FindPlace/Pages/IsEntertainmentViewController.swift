//
//  IsEntertainmentViewController.swift
//  placeby
//
...
class IsEntertainmentViewController: UIViewController {
    // MARK: - Lifecycle
    ...
    private let helloLabel: UILabel = {
        ...
        label.text = "Включать знаковые места?"
...
private extension IsEntertainmentViewController {
    func initialization() {
    ...
    @objc func yesButtonPressed(){
        UserDefaults.standard.setValue(true, forKey: "isEntertainment")
        continueButtonPressed()
    }
    
    @objc func noButtonPressed(){
        UserDefaults.standard.setValue(false, forKey: "isEntertainment")
        continueButtonPressed()
    }
