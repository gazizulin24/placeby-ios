...
final class MapBottomView: UIView {
    ...
    private lazy var typesCollectionView: MapPlacesTypesCollectionView = {
    ...
    private lazy var placesCollectionView: MapPlacesCollectionView = {
        let layout = UICollectionViewFlowLayout()
        layout.scrollDirection = .horizontal
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView == typesCollectionView {
            ...
            case .me:
                ...
                return cell
            case let .placeType(title, placeType):
